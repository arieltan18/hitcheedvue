        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="privacy-content">
                    <h3 class="privacy-content-title">What is this Privacy Policy for?</h3>
                    <p class="privacy-content-paragraph">
                        This privacy policy is for this website www.hitcheed.com and governs the privacy of its users who choose to use it.
                        <br/><br/>
                        The policy sets out the different areas where user privacy is concerned and outlines the obligations &amp; requirements of the users, the website and website owners. Furthermore the way this website processes, stores and protects user data and information will also be detailed within this policy.
                    </p>
                    <h3 class="privacy-content-title">The Website</h3>
                    <p class="privacy-content-paragraph">This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience.</p>
                    
                    <h3 class="privacy-content-title">Use of Cookies</h3>
                    <p class="privacy-content-paragraph">
                    ...
                    <h3 class="privacy-content-title">External Links</h3>
                    <p class="privacy-content-paragraph">
                    ...
                    <h3 class="privacy-content-title">Adverts and Sponsored Links</h3>
                    <p class="privacy-content-paragraph">
                    ...
                    <h3 class="privacy-content-title">Social Media Platforms</h3>
                    <p class="privacy-content-paragraph">
                    ...
                    <h3 class="privacy-content-title">Shortened Links in Social Media</h3>
                    <p class="privacy-content-paragraph">
