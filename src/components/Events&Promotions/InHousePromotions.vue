<template>
    <div class="mb">
        ...
        <div class="container mb-4">
            <div class="row"> 
                <div class="col-md-3 box" v-for="promotion in promotions.data" :key="promotion.id">
        ...
        <div class="container">
            <div class="row"> 
                <div class="col-md-3 box" v-for="promotion2 in promotions2.data" :key="promotion2.id">
